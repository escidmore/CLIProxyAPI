...
func forwardOAuthCompletionHeader(name string) bool {
	...
	switch canonical {
	case "Authorization", "X-Api-Key", "Accept", "Accept-Encoding", "Content-Type", "Host", "Connection", "Proxy-Connection", "Transfer-Encoding", "Upgrade", "Content-Length", "Content-Encoding":
